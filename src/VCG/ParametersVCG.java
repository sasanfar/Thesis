...
public class ParametersVCG {
	...
	public static void configureCplex(MasterProblemVCG masterProblem) {
		try {
			// branch and bound
	...
	public static void configureCplex(PricingProblemVCG subProblem) {
		try {
			// branch and bound
			subProblem.cplex
