...
//			statement = connection.createStatement();
	...
	public Connection getConnectionToDB() {
		try {
			...
			return DriverManager.getConnection(db_connect_string, "open_user",
					"bell");
		} catch (Exception ex) {
			ex.printStackTrace();
			return null;
...
//	}
	...
	public void writeLog(double objValue, double bestObjValue) {
		// TODO Auto-generated method stub
		
	}

//	public void writeLog(double obj, double bb) {
//		executeSql("INSERT INTO Logs VALUES ('" + session + "','" + "',"
//				+ timeStamp() + "," + obj + "," + bb + ",'" + pc_name + "');");
//	}
